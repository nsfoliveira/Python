...
def jogar():
    ...
    for rodada in range(1, total_tentativa + 1):
        print("\nTentativa {} de {}".format(rodada, total_tentativa))
        #string interpolationchute = input("Digite um número de 1 a 100: ")
        ...
        if(chute_convert < 1 or chute_convert > 100):
            ...
            continue
        #ele não quebra o laçochute_convert = int(chute)
        ...
        if(acertou):
            ...
            break
        #parar o laço quando acertar,    else:
            if(maiorq):
